        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h4 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome to OKX EXCHANGE TRADE Official Cryptocurrency Platform, your Number 1 online trading platform.</h4>
              <span>
        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h4 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">You have successfully logged in to,<br/> <span style=" font-weight: 500; color:#EABD4E; margin-top:-10px; font-size: 20px;">OKX EXCHANGE TRADE Official Cryptocurrency Platform</span></h4>
