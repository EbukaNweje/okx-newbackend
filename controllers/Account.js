...
{/* <h4>Hi ${newAccount.userName}</h4>
            ...
            <br>
            OKX EXCHANGE TRADEcrypfield@gmail.com
           </p> */}
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="text-align: center;">
                    <!-- <h1 style="margin: 0;"><a href="#" style="color: #EABD4E; font-size: 24px; font-weight: 700; font-family: 'Lato', sans-serif;">OKX EXCHANGE TRADE</a></h1> -->
                  </td>
                </tr>
              </table>
            </td>
...
exports.sendWithdrawCode = async (req, res,next) => {
    ...
    //    <Span>Use the following one-time password (OTP) to make a Withdrawal on OKX EXCHANGE TRADE TRADE PLATFORM account. <br>
    ...
    //    <p>Regards, <br>
    //    OKX EXCHANGE TRADE<br>
    //    OKX EXCHANGE TRADE.org</p>
          ...
          <tr>
            <td>
              <div style="padding: 0 1.5em; text-align: center;">
                ...
                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Use the following one-time password (OTP) to make a Withdrawal on OKX EXCHANGE TRADE TRADE PLATFORM account. <br>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="text-align: left; padding-left: 10px;">
                    ...
                    <ul>
                      <li style="color: #fff;"><a href="https://OKX EXCHANGE TRADEcrypfield.org" style="color: #30e3ca;">Home</a></li>
                      <li style="color: #fff;"><a href="https://OKX EXCHANGE TRADEcrypfield.org/about" style="color: #30e3ca;">About</a></li>
                      <li style="color: #fff;"><a href="https://OKX EXCHANGE TRADEcrypfield.org/faq" style="color: #30e3ca;">FAQ</a></li>
                      <li style="color: #fff;"><a href="https://OKX EXCHANGE TRADEcrypfield.org/sendrequest" style="color: #30e3ca;">Ask a question</a></li>
                    </ul>
                  </td>
                </tr>
              </table>
